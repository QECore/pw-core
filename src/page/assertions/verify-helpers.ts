...
export async function verifyHidden(
  ...
  target: any,
  options?: Parameters<ReturnType<typeof playwrightExpect<Locator>>['toBeHidden']>[0] & { nth?: number; message?: string }
): Promise<void> {
...
export async function verifyEnabled(
  resolveLocator: (target: any, options?: { nth?: number; raw?: boolean }) => Locator,
  target: any,
  options?: Parameters<ReturnType<typeof playwrightExpect<Locator>>['toBeEnabled']>[0] & { nth?: number; message?: string }
): Promise<void> {
...
export async function verifyDisabled(
  resolveLocator: (target: any, options?: { nth?: number; raw?: boolean }) => Locator,
  target: any,
  options?: Parameters<ReturnType<typeof playwrightExpect<Locator>>['toBeDisabled']>[0] & { nth?: number; message?: string }
): Promise<void> {
